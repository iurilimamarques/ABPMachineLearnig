...
dataframe = pd.read_csv(large_files_folder + '/MICRODADOS_ENEM_2023.csv', encoding='latin-1', sep=';')
...
with open(large_files_folder + '/encoder.pkl', 'wb') as file:
    pickle.dump(ordinal, file)

joblib.dump(value=[model, ref_cols, target], filename=large_files_folder + '/model_nota_MEDIA.pkl')